...
ActiveRecord::Schema.define(version: 20_160_221_154_113) do
  ...
  add_index 'hierarchy_hierarchies', %w(ancestor_id descendant_id generations), name: 'hierarchy_anc_desc_idx', unique: true
