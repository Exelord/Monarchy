...
ActiveRecord::Schema.define(version: 20_160_502_212_213) do
  ...
  add_index 'monarchy_hierarchy_hierarchies', %w(ancestor_id descendant_id generations), name: 'hierarchy_anc_desc_idx', unique: true
  ...
  add_index 'monarchy_members_roles', %w(role_id member_id), name: 'index_monarchy_members_roles_on_role_id_and_member_id', unique: true
